...
import { createRollback, createRollbackSync, snapshot, snapshotSync } from './directory';

const testfile = './testfile.txt';

describe('snapshot', () => {
  const testfilePath = './testfiles/dir/async/testfile.txt';
  const testdir = './testfiles/dir/async';
  ...
  it('should rollback changes', async () => {
    ...
    const testfile2 = './testfiles/dir/async/testfile2.txt';
...
describe('snapshotSync', () => {
  const testfilePath = './testfiles/dir/sync/testfile.txt';
  const testdir = './testfiles/dir/sync';
  ...
  it('should rollback changes syncronously', () => {
    ...
    const testfile2 = './testfiles/dir/sync/testfile2.txt';
